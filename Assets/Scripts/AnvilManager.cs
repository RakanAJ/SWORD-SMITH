...
public class AnvilManager : MonoBehaviour
{
    ...
    private void OnTriggerStay(Collider other)
    {
        if (other.GetComponent<MalleableMaterial>()) // if it is a malleable material
        {
            ...
            if (other.GetComponent<DistanceGrabInteractable>()) // check for grabbable component
            {
    ...
    {
        if (other.GetComponent<DistanceGrabInteractable>() && other.gameObject.layer != 11) // check objects are grabbable
        {
